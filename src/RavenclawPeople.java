public class RavenclawPeople extends HogwardsPeople {
    private int cleverness;
    private int wisdom;
    private int wit;
    private int creativity;

    public RavenclawPeople(String name,
                           int magic,
                           int transgression,
                           int cleverness,
                           int wisdom,
    ...
    public void compareRavenclaw(RavenclawPeople ravenclawPeople) {
        int ability1 = ability();
        int ability2 = ravenclawPeople.ability();
        if (ability1 > ability2) {
            System.out.printf(
                    "Когтевранец %s лучше, чем когтевранец %s: %d VS %d%n",
                    getName(),
                    ravenclawPeople.getName(),
                    ability1,
                    ability2
            );
        } else if (ability2 > ability1) {
            System.out.printf("Когтевранец %s лучше, чем когтевранец %s: %d VS %d%n", ravenclawPeople.getName(),
                    getName(),
                    ability2,
                    ability1);
        } else {
